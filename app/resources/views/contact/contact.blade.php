                    ...
                    <div class="row mt-4">
                        <form action="contact" class="contact-form p-4" method="post" id="contact_form">
                            ...
                            <div class="form-group">
                                <label for="name"
                                    class="form-label">{{ __('contactme.contactme_input_name') }}</label>
                                <input type="text" class="form-control" required id="name" name="name">
                            </div>
                            <div class="form-group mt-4">
                                <label for="email"
                                    class="form-label">{{ __('contactme.contactme_input_email') }}</label>
                                <input type="email" class="form-control" required id="email" name="email"
                                    placeholder="name@example.com">
                            </div>
                            <div class="form-group mt-4">
                                <label for="subject"
                                    class="form-label">{{ __('contactme.contactme_input_subject') }}</label>
                                <input type="text" class="form-control" id="subject" name="subject">
                            </div>
                            <div class="form-group mt-4">
                                <label for="message"
                                    class="form-label">{{ __('contactme.contactme_input_message') }}</label>
